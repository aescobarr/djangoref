...
router.register(r'protocols', views.ProtocolsViewSet, base_name='protocols')
...
urlpatterns = [
    ...
    url(r'^datatableprotocols/list$', views.protocol_datatable_list, name='protocol_datatable_list'),
    ...
    url(r'^thesaurus/protocols/$', views.t_protocols, name='t_protocols'),
